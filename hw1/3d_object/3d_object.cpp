...
glm::mat4 ComputeMVPFromTime(double time,
                             glm::vec3 initialPos = glm::vec3(0, 0, 0)) {
  glm::vec3 newPos = initialPos + glm::vec3(glm::cos(time) * 5,glm::cos(time) * 5, glm::sin(time) * 5);
  glm::mat4 Projection =
...
int main() {
  ...
  window = glfwCreateWindow(500, 500, "3d object", nullptr, nullptr);
  if (window == nullptr) {
    fprintf(stderr,
  ...
  static const GLfloat g_vertex_buffer_data[] = {
      0.0f, 0.9f, 0.0f, 0.0f,  0.0f, 0.9f,  0.9f,  0.0f, -0.9f,  // edge 1
      0.0f, 0.9f, 0.0f, 0.9f,  0.0f, -0.9f, -0.9f, 0.0f, -0.9f,  // edge 2
      0.0f, 0.9f, 0.0f, 0.0f,  0.0f, 0.9f,  -0.9f, 0.0f, -0.9f,  // edge 3
      0.0f, 0.0f, 0.9f, -0.9f, 0.0f, -0.9f, 0.9f,  0.0f, -0.9f}; // edge 4
